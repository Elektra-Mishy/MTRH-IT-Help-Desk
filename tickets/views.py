...
from .models import Ticket, TicketLog, Category
from departments.models import Department
from .forms import CommentForm, TicketAssignForm
    ...
    if request.method == 'POST':
        ...
        if 'add_comment' in request.POST:
            ...
            if assign_form.is_valid():
                ...
                # email technician when newly assigned
                if updated.assigned_to and updated.assigned_to != old_assigned:
                    if updated.assigned_to.email:
                        send_ticket_assigned_email(updated, updated.assigned_to)

                # email staff when ticket is resolved
                if updated.status == 'resolved' and old_status != 'resolved':
                    if updated.created_by.email:
                        send_ticket_resolved_email(updated)
